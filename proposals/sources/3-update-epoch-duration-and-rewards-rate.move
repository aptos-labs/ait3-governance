script {
    ...
    fun main(proposal_id: u64) {
        ...
        // Update epoch duration from 1 hours to 2 hour.
        let updated_epoch_duration_secs = 2 * 60 /* minutes */ * 60 /* seconds */;
        ...
        // Double current rewards rate to keep effective APY the same (since epoch duration is doubled).
